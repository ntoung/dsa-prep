...
import { CODE_FONT_SIZES, DIFFICULTIES, LANGUAGES, PRACTICE_MODES } from '../hooks/useSettings'
    ...
    <div className="settings-view">
      ...
      <div className="settings-grid">
        ...
        <div className="stats-card">
          ...
          <p className="settings-hint">
            Sprinkle occasional pattern/complexity quiz cards into the Swipe deck for problems you've already
            reviewed.
          </p>
          <div className="settings-size-pills">
            <button
        ...
        <div className="stats-card">
          ...
          <p className="settings-hint">
            Sprinkle occasional Recognize/Template/Tips pattern cards from Learn into the Swipe deck, weighted
            toward your weakest categories.
          </p>
          <div className="settings-size-pills">
            <button
              type="button"
              className={`filter-pill${settings.enablePatternCards ? ' active' : ''}`}
              onClick={() => settings.setEnablePatternCards(true)}
            >
              On
            </button>
            <button
              type="button"
              className={`filter-pill${!settings.enablePatternCards ? ' active' : ''}`}
              onClick={() => settings.setEnablePatternCards(false)}
            >
              Off
            </button>
          </div>
